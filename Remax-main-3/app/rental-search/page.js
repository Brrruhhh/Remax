          ...
          <div className="bg-white rounded-2xl p-6">
                ...
                <div className="flex gap-3">
                  {["NO MIN", "1", "2", "3", "4"].map((option) => (
                    <button
                      ...
                      className={`flex-1  py-2 border-2  text-sm font-medium transition-all duration-300 ${
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="bg-[#dc1c2e] text-white px-6 py-2 font-semibold"
              >
                Search Rentals
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-12">
            <div>
              ...
              <p className="text-sm text-gray-600">Discover amazing rental homes in your area</p>
            </div>
          ...
          <div className="text-center mt-16">
            ...
            <p className="text-gray-600 mt-4">Showing 6 of 892 rental properties</p>
          </div>
        </div>
      </section>
      <Footer />
